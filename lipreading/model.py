...
from video_transformers.necks import GRUNeck, TransformerNeck
...
class Lipreading(nn.Module):
    def __init__(
        ...
        self.neck = nn.TransformerEncoderLayer(
        ...
        self.head = LinearHead(hidden_size=num_features, num_classes=num_classes)
