...
def get_preprocessing_pipelines(modality, mean=0.421, std=0.165):
...
def get_data_loaders(args, mean=0.421, std=0.165):
    preprocessing = get_preprocessing_pipelines(args.modality, mean, std)
